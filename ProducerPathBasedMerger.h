...
class ProducerPathBasedMerger
{
	...
	bool GetPathBasedMerger(vector<map<int, int>>& _directed, vector<int>& _capacities, vector<bool>& Snu, vector<int>& V, vector<int>& _path);
...
public:
	bool Exist(vector<map<int, int>>& _directed, vector<int>& _capacities, vector<int>& _path);
};
