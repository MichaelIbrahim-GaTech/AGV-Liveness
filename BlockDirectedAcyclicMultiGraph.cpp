...
BlockDirectedAcyclicMultiGraph::BlockDirectedAcyclicMultiGraph(DirectedAcyclicMultiGraph* _U, set<int> Block)
...
bool BlockDirectedAcyclicMultiGraph::IsThereATerminalNodeThatDoesntHaveMaximalCapacity(CondensedMultiGraph* _C)
{
...
bool BlockDirectedAcyclicMultiGraph::ExistAMeregerSequenceForATerminalNode(CondensedMultiGraph* _C, bool& _terminate)
{
...
void BlockDirectedAcyclicMultiGraph::Algorithm4_NAHS(CondensedMultiGraph* _C)
{
	vector<int> L;
	set<int> Lset;
